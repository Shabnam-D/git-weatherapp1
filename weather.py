...
def getWeather():
    ...
    clock.config(text=current_time)
     ...
     #weather
    api="https://api.openweathermap.org/data/2.8/onecall?lat="+str(location.latitude)+"&lon="+str(location.longitude)+"&units=metric&exclude=hourly&appid=5c6683a0ce750cee468804dc388b3771"
...
#label
label1=Label(root,text="Temperature",font=('Copperplate Gothic Bold',11),fg="white",bg="#203243")
label1.place(x=50,y=120)



label2=Label(root,text="Humidity",font=('Copperplate Gothic Bold',11),fg="white",bg="#203243")
label2.place(x=50,y=140)



label3=Label(root,text="Pressure",font=('Copperplate Gothic Bold',11),fg="white",bg="#203243")
label3.place(x=50,y=160)




label4=Label(root,text="Wind Speed",font=('Copperplate Gothic Bold',11),fg="white",bg="#203243")
label4.place(x=50,y=180)




label5=Label(root,text="Description",font=('Copperplate Gothic Bold',11),fg="white",bg="#203243")
...
textfield=tk.Entry(root,justify='left',insertbackground="white",width=15,font=('poppins',25,'bold'),bg="#203243",border=0,fg="white")
...
textfield = tk.Entry(root, justify='center', insertbackground="white", width=15, font=('poppins', 25, 'bold'), bg="#203243", border=0, fg="white")
textfield.place(x=370, y=130)
textfield.focus()
...
#clock(here we will placed time)
clock=Label(root,font=("Helvetica",30,'bold'),fg="white",bg="#57adff")
clock.place(x=30,y=20)                    


#timezone
timezone=Label(root,font=("Helvitica",20),fg="white",bg="#57adff")
...
#thpwd
t=Label(root,font=("Helvitica",11),fg="white",bg="#203243")
t.place(x=150,y=120)
h=Label(root,font=("Helvitica",11),fg="white",bg="#203243")
h.place(x=150,y=140)
p=Label(root,font=("Helvitica",11),fg="white",bg="#203243")
p.place(x=150,y=160)
w=Label(root,font=("Helvitica",11),fg="white",bg="#203243")
w.place(x=150,y=180)
d=Label(root,font=("Helvitica",11),fg="white",bg="#203243")
d.place(x=150,y=200)
